...
void FailoSukurimas(vector <Studentas>& grupe, int failoDydis, int pazymiuSkaicius)
{
	...
	cout << "Failo sugeneruotas" + std::to_string(failoDydis) + ".txt" " generavimas truko: " << generacija/1000 << "s" << endl;
	Skaitymas(grupe);
	...
	cout << "Failo rikiavimas truko " << Rikiavimas/1000 << "s" << endl;
	...
	cout << "Failo rusiavimas truko: " << rusiavimas/1000 << "s" << endl;
	...
	cout << "Failo isvedimas truko: " << isvedimas/1000 << "s" << endl;

	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count();
	std::cout << "Programos trukme: " << duration/1000 << "s\n";
}
...
void Skaitymas(vector <Studentas>& grupe)
{
	...
	cout << "Failo nuskaitymas truko: " << skaitymas/1000 << "s" << endl;
