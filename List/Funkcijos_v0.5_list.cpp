...
void FailoSukurimas(list <Studentas>& grupe, int failoDydis, int pazymiuSkaicius)
{
	...
	std::cout << "Programos trukme: " << fixed << setprecision(4) << static_cast<double>(generacija+Rikiavimas+rusiavimas+nuskaitymas) / 1000 << "s" << endl;
}
