#include "Header.h"
#include "Funkcijos_v0.5_deque.h"

void FailoSukurimas(deque <Studentas>& grupe, int failoDydis, int pazymiuSkaicius)
{
	...
	cout << "Failo sugeneruotas" + std::to_string(failoDydis) + ".txt" " generavimas truko: " << fixed << setprecision(4) << static_cast<double>(generacija) / 1000 << "s" << endl;
	float nuskaitymas;
	...
	cout << "Failo rikiavimas truko " << fixed << setprecision(4) << static_cast<double>(Rikiavimas) / 1000 << "s" << endl;
	...
	cout << "Failo rusiavimas truko: " << fixed << setprecision(4) << static_cast<double>(rusiavimas) / 1000 << "s" << endl;
	...
	cout << "Failo isvedimas truko: " << fixed << setprecision(4) << static_cast<double>(isvedimas) / 1000 << "s" << endl;

	auto end = std::chrono::high_resolution_clock::now();
	auto duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count();
	//std::cout << "Programos trukme: " << fixed << setprecision(4) << static_cast<double>(duration) / 1000 << "s" << endl;
	std::cout << "Programos trukme: " << fixed << setprecision(4) << static_cast<double>(generacija+Rikiavimas+rusiavimas+isvedimas+nuskaitymas) / 1000 << "s" << endl;
}
...
void Skaitymas(deque <Studentas>& grupe, float& nuskaitymas)
{
	...
	cout << "Failo nuskaitymas truko: " << fixed << setprecision(4) << static_cast<double>(skaitymas) / 1000 << "s" << endl;
